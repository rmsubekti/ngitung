...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/ngitung/sw.js',{scope:'/ngitung/'}).then(function(reg){
        //Berhasil terdaftar reg.scope
        console.log('◕‿◕:' + reg.scope)
    }).catch(function(error){
        //Gagal Terdaftar error
...
btnJawab.addEventListener("click", function(){
  if (soal.jawab == inpJawab.value) {
    ...
    if (lv.skor <= 0) {
      ...
      resetGame();
    } else outHasil.innerHTML = "ಠ_ಠ<br/> Salah";
  }
